...
livro = Livro('Como fazer amigos e influenciar pessoas')
...
carro = Carro('hyundai','creta', 2013)
...
funcionario = Funcionario("Caio", 15000, "Software Engenier")
